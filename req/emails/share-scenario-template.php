  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#007bff">
        <a href="https://hawg-ops.com/cas?scenario%5B%5D=__SCENARIOID__&amp;share=1" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #007bff; color: #ffffff; padding: 8px 12px; border: 1px solid #007bff;">View Scenario</a>
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
      <td height="48" style="border-spacing: 0px; border-collapse: collapse; line-height: 48px; font-size: 48px; width: 100%; height: 48px; margin: 0;" align="left">
        ...
        <small>You must be logged into Hawg Ops to view this scenario. You will be directed to login or create an account as required.</small>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
    <tbody>
      <tr>
        ...
        <a href="https://hawg-ops.com/cas?scenario%5B%5D=__SCENARIOID__&amp;share=1"><small>https://hawg-ops.com/cas?scenario[]=__SCENARIOID__&amp;share=1</small></a>
