 ...
 <body class="bg-light">
   <div class="container">
	<div class="card mt-3" style="border-top:5px solid #007bff;">
      ...
      <div class="card-body">
        <h3>__SHAREDTO__,</h3>
        <p class="mt-2">__SHAREDBY__ has shared a Hawg Ops CAS Scenario with you titled __SCENARIONAME__. Please click on the button below to view the scenario.</p>
        <a class="btn btn-primary mx-auto my-5" href="https://hawg-ops.com/cas?scenario[]=__SCENARIOID__&share=1">View Scenario</a>
