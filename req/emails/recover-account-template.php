																				...
																				<tbody>
																					<tr>
																						<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
																							...
																							<img class="  " width="42" height="30" src="https://hawg-ops.com/images/favicon.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
																							<table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
																								<tbody>
																									<tr>
																										<td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left">
																					...
																					<tr>
																						<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
																							<div>
																								...
																								<p class="" style="line-height: 24px; font-size: 16px; margin: 0;" align="left">We received a request to recover your account on Hawg Ops. It may have been disabled due to inactivity or for security purposes. Click the button below to start the process. This password reset is only valid for the next 30 minutes.</p>
																								...
																								<p style="line-height: 24px; font-size: 16px; margin: 0;" align="left">Thanks,</p>
																								...
																								<small class="">We recommend that you keep your password secure and not share it with anyone. If you feel your password has been compromised, you can change it by going to your Account Settings page.</small>
																								<table class="s-2 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
																									<tbody>
																										<tr>
																											<td height="8" style="border-spacing: 0px; border-collapse: collapse; line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;" align="left">
																								...
																								<small class="">If you did not initiate this request, please contact us immediately by replying to this email.</small>
																								...
																								<small>If you're having trouble clicking the button, copy and paste the following URL into your web browser.</small>
																								<a href="https://hawg-ops.com/recover-account?email=__EMAIL__&token=__TOKEN__"><small>https://hawg-ops.com/recover-account?email=__EMAIL__&token=__TOKEN__</small></a>
																							</div>
																						</td>
																					</tr>
																				</tbody>
