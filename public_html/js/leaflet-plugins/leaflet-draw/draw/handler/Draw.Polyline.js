...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	_fireCreatedEvent: function () {
		...
		if (this.type == "polygon") {
			...
			this.options.shapeOptions.type = this.type;
			this.options.shapeOptions.title = label;
			this.options.shapeOptions.latlngs = this._poly.getLatLngs();
			
			var poly = new this.Poly(this._poly.getLatLngs(), this.options.shapeOptions);
			
			poly.bindPopup(label + "<hr/><input type=\"text\" class=\"form-control polygon-rename\"><button class=\"btn btn-sm btn-warning btn-polygon-rename\">Rename</button><button class=\"btn btn-sm btn-danger btn-polygon-del\">Delete</button>");
			poly.on("click", polygonClicked);
			...
			poly.bindPopup(label + "<hr/><input type=\"text\" class=\"form-control feba-rename\"><button class=\"btn btn-sm btn-warning btn-feba-rename\">Rename</button><button class=\"btn btn-sm btn-danger btn-feba-del\">Delete</button>");
			poly.on("click", febaClicked);
		}
