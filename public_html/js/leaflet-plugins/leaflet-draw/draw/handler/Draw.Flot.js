 ...
 */
L.Draw.Flot = L.Draw.Feature.extend({
	statics: {
		TYPE: 'flot'
	},
	...
	initialize: function (map, options) {
		...
		this.options.drawError.message = L.drawLocal.draw.handlers.flot.error;
	...
	_fireCreatedEvent: function () {
		if($("#chit-description").val() == "") {
			var label = "FLOT";
		} else {
			var label =	$("#chit-description").val();
		}
		
		this.options.shapeOptions.type = "flot";
		this.options.shapeOptions.title = label;
		this.options.shapeOptions.latlngs = this._poly.getLatLngs();
		
		var poly = new this.Poly(this._poly.getLatLngs(), this.options.shapeOptions);	
		
		poly.bindPopup(label + "<hr/><input type=\"text\" class=\"form-control flot-rename\"><button class=\"btn btn-sm btn-warning btn-flot-rename\">Rename</button><button class=\"btn btn-sm btn-danger btn-flot-del\">Delete</button>");
		
		poly.on("click", flotClicked);
