		...
		<script>
			$(document).ready(function() {
				grecaptcha.ready(function() {
					grecaptcha.execute("<?php echo $site_key; ?>", {action: "terms"}).then(function(token) {
						$.ajax({
							...
							success: function(data, textStatus, jqXHR) {
								...
								if(parseFloat(data) <= <?php echo $thresh_terms; ?>) {
		...
		<div id="body-container" class="container">
			...
			<div class="card my-5 mx-auto">
				<div class="card-body">
					...
					<p>These terms and conditions (&quot;Terms&quot;, &quot;Agreement&quot;) are an agreement between Website Operator (&quot;Website Operator&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;) and you (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;). This Agreement sets forth the general terms and conditions of your use of the <a target="_blank" rel="nofollow" href="https://hawg-ops.com">hawg-ops.com</a> website and any of its products or services (collectively, &quot;Website&quot; or &quot;Services&quot;).</p>
					...
					<h2>Contacting us</h2>
					<p>If you would like to contact us to understand more about this Agreement or wish to contact us concerning any matter relating to it, you may do so via the <a target="_blank" rel="nofollow" href="https://hawg-ops.com/contact">contact form</a></p>
